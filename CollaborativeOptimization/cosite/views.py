...
# # api4_current_taskid 刷新页面是的请求，返回当前state为true的测试用例id，若无则返回0
# def api4_current_taskid(req):
#     if req.method == 'POST':
#         # temp = req.POST
#         # print(temp)
#         d = json.loads(req.body.decode('utf-8'))
#         print(d)
#
#         current_task = TestCaseState.objects.filter(current_state=True)[-1]
#
#         if current_task:
#             current_taskid = current_task.task_id
#             current_tasktype = current_task.type_name
#
#             print('========')
#             print(current_taskid)
#             print(current_tasktype)
#             print('========')
#             data = {'current_taskID': current_taskid, 'current_taskType': current_tasktype}
#         else:
#             data = {'current_taskID': None, 'current_taskType': None}
#         return HttpResponse(json.dumps(data), content_type='application/json')
#     return HttpResponse('Permission denied!', status=403)
#
#
# # 实时数据，显示在？
# def api4_current_realtime(req):
#     if req.method == 'POST':
#         # temp = req.POST
#         # print(temp)
#         d = json.loads(req.body.decode('utf-8'))
...
#
#         obj = TestCaseState.objects.get(task_id=task_id)
#         session_number = obj.set_session
#         flow_type = -1
...
#
#         if task_type == 1:
#             obj1 = PPPoESessionTest.objects.filter(task_id=task_id)[-1]
#             session_number_now = obj1.session_num
#             data = {'sessionNumber': session_number, 'flowType': flow_type, 'addTime': add_time,
#                   'CPU_now': cpu_now, 'Memory_now': memory_now, 'sessionNumber_now': session_number_now}
#         elif task_type == 2:
#             obj2 = UserTransTest.objects.filter(task_id=task_id)[-1]
#             frame_size = obj2.frame_size
#             latency_avg = obj2.avg_latency
#             latency_max = obj2.max_latency
#             latency_min = obj2.min_latency
#             latency_now = -1
#             data = {'sessionNumber': session_number, 'flowType': flow_type, 'addTime': add_time,
#                     'CPU_now': cpu_now, 'Memory_now': memory_now, 'frameSize': frame_size,
#                     'latency_avg': latency_avg, 'latency_max': latency_max, 'latency_min': latency_min,
#                     'latency_now': latency_now}
#         else:
#             data = {'sessionNumber': session_number, 'flowType': flow_type, 'addTime': add_time,
#                     'CPU_now': cpu_now, 'Memory_now': memory_now}
#
#         return HttpResponse(json.dumps(data), content_type='application/json')
#     return HttpResponse('Permission denied!', status=403)
#
...
#         add_time = obj.add_time
#         session_number = obj.set_session  # ??
#         task_type = obj.type_name
#         type_obj = -1
#
#         print(d)
#
#         data = {'taskType': task_type, 'sessionNumber': session_number, 'Type': type_obj, 'addTime': add_time}
#         return HttpResponse(json.dumps(data), content_type='application/json')
#     return HttpResponse('Permission denied!', status=403)
#
#
# # 性能资源比的实时？
# def api4_current_task_chart(req):
#     if req.method == 'POST':
#         # temp = req.POST
#         # print(temp)
#         d = json.loads(req.body.decode('utf-8'))
...
#             obj1 = PPPoESessionTest.objects.filter(task_id=task_id)[-1]
#
#             data = {'stability_CPU': stability_cpu, 'stability_Memory': stability_memory}
#         elif task_type == 2:
#             obj2 = UserTransTest.objects.filter(task_id=task_id)[-1]
#
#             data = {'stability_CPU': stability_cpu, 'stability_Memory': stability_memory}
...
#         items = TestCaseState.objects.only('task_id', 'type_name') \
#             .filter(add_time__gt=start_time, add_time__lt=end_time).all()
#         # data = []
#         # for item in items:
#         #     rst={}
#         #     rst['task_id'] = getattr(item, 'task_id')
#         #     rst['type_name'] = getattr(item, 'type_name')
#         #     data.append(rst)
...
def api4_index_task_details(req):
    if req.method == 'POST':
        ...
        if tasktype == '1':
            ...
            # data = {'frame_size_64': frame_size_64, 'frame_size_128': frame_size_128,
